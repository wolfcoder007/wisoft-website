<div class="box-body">
    <div class='form-group{{ $errors->has("$lang.title") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("{$lang}[title]", old("$lang.title"), ['class' => 'form-control', 'data-slug' => 'source', 'placeholder' => trans('casestudies::casestudies.form.title')]) !!}
    ...
    <div class='form-group{{ $errors->has("$lang.author") ? ' has-error' : '' }}'>
       ...
       {!! Form::text("{$lang}[author]", old("$lang.slug"), ['class' => 'form-control author', 'data-author' => 'target', 'placeholder' => trans('casestudies::casestudies.form.author')]) !!}
       {!! $errors->first("$lang.author", '<span class="help-block">:message</span>') !!}
    </div>


    @editor('content', trans('casestudies::casestudies.form.content'), old("{$lang}.content"), $lang)
