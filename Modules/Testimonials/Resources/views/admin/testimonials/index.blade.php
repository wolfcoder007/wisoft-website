                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            ...
                            <tr>
                                <th>Id</th>
                                <th>{{ trans('testimonials::testimonials.table.title') }}</th>
                                <th>{{ trans('testimonials::testimonials.table.author') }}</th>
                                <th>{{ trans('testimonials::testimonials.table.content') }}</th>
