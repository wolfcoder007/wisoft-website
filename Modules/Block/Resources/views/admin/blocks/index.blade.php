                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            ...
                            <tr>
                                <th>Id</th>
                                <th>{{ trans('block::blocks.table.title') }}</th>
                                <th>{{ trans('block::blocks.table.author') }}</th>
                                <th>{{ trans('block::blocks.table.content') }}</th>
                                <th>{{ trans('block::blocks.table.status') }}</th>
                                <th>{{ trans('block::blocks.table.category') }}</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="label {{ $block->present()->statusLabelClass }}">
                                        {{ $block->present()->status }}
                                    </span>
                                </td>
                                
                                        <?php foreach ($categories as $id => $category): ?>
                                     @if($block->category_id == $id) 
                              <td>
                                        <a href="{{ route('admin.block.block.edit', [$block->id]) }}">
                                        {{ $category }}
                                    </a>
