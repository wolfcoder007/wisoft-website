...
use Modules\Block\Presenters\BlockPresenter;
...
{  
    ...
    protected $presenter = BlockPresenter::class;
    protected $casts = [
        'is_home' => 'boolean',
        'status' => 'int',
    ];
    ...
    protected static $entityNamespace = 'asgardcms/block';
    ...
    public function __call($method, $parameters)
    {
        ...
        $config = implode('.', ['asgard.block.config.block.relations', $method]);
