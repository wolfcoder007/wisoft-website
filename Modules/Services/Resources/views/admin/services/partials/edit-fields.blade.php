<div class="box-body">
    <div class='form-group{{ $errors->has("$lang.title") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("{$lang}[title]", old("$lang.title", $service->title), ['class' => 'form-control', 'data-slug' => 'source',  'placeholder' => trans('services::services.form.title')]) !!}
    ...
    <div class='form-group{{ $errors->has("$lang.author") ? ' has-error' : '' }}'>
       ...
       {!! Form::text("{$lang}[author]", old("$lang.author", $service->author), ['class' => 'form-control author', 'data-author' => 'target', 'placeholder' => trans('services::services.form.author')]) !!}
       {!! $errors->first("$lang.author", '<span class="help-block">:message</span>') !!}
    </div>

    
    @editor('content', trans('services::services.form.content'), old("{$lang}.content",  $service->content), $lang)
