...
class ContactRequestController extends AdminBaseController
{
    ...
    {
        return view('contact::admin.contactrequests.create');
    }
    ...
    public function store(CreateContactRequestRequest $request)
    {
        ...
        return redirect()->route('admin.contact.contactrequest.index')->withSuccess('We received your request. We\'ll get back to you soon.');
    }
}
