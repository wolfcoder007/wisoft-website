...
@section('content-header')
    <h1>
        {{ trans('industry::industries.title.create industry') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.industry.industry.index') }}">{{ trans('industry::industries.title.industries') }}</a></li>
        <li class="active">{{ trans('industry::industries.title.create industry') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.industry.industry.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-10">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('industry::admin.industries.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
