            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table class="data-table table table-bordered table-hover">
                        ...
                        <tr>
                            <th>Id</th>
                            <th>{{ trans('page::pages.name') }}</th>
                            <th>{{ trans('page::pages.slug') }}</th>
                            <th>{{ trans('page::pages.status') }}</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ URL::route('admin.page.page.edit', [$page->id]) }}">
                                    {{ $page->title }}
                                    {{ isset($page->is_home) && (bool)$page->is_home == true ? '--Front Page' : '' }}
                                </a>
                            </td>
                            <td>
                                <a href="{{ URL::route('admin.page.page.edit', [$page->id]) }}">
                            ...
                            <td>
                                <a href="{{ URL::route('admin.page.page.edit', [$page->id]) }}">
                                    {{ isset($page->status) && (bool)$page->status == true ? 'Yes' : 'No' }}
                                </a>
                            </td>
                            <td>
                                <a href="{{ URL::route('admin.page.page.edit', [$page->id]) }}">
